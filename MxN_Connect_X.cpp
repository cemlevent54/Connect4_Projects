...
void showmenu();
void printboard(char board[100][100],int r,int c);
void clearboard(char board[100][100],int r,int c);
void playgame(char board[100][100],char player1, char player2, int movesplayed,int r,int c,int slot);
int makemove(char board[100][100],int movesplayed, char player1, char player2, int r);
int checkforwinner(char board[100][100],char player1, char player2,int r,int c,int slot);
bool checkmatch(char board[100][100], string pat, int r,int c);
bool matchforrows(char board[100][100],string pat,int x,int y, int r,int c,int level);
bool matchforcolumns(char board[100][100],string pat,int x,int y, int r,int c,int level);
bool matchforbottomrightdiagonals(char board[100][100],string pat,int x,int y, int r,int c,int level);
bool matchforbottomleftdiagonals(char board[100][100],string pat,int x,int y, int r,int c,int level);
bool matchfortopleftdiagonals(char board[100][100],string pat,int x,int y, int r,int c,int level) ;
bool matchfortoprightdiagonals(char board[100][100],string pat,int x,int y, int r,int c,int level);
